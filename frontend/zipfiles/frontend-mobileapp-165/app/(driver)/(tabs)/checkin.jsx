...
const VehicleDetailsSection = memo(({
  ...
  return (
    <>
      ...
      <View style={[inputRow, errors.plate && { borderColor: theme.colors.danger, marginBottom: 0 }]} ref={el => { if (fieldRefs && fieldRefs.current) fieldRefs.current.plate = el; }}>
      ...
      <View style={[inputRow, errors.guestName && { borderColor: theme.colors.danger, marginBottom: 0 }]} ref={el => { if (fieldRefs && fieldRefs.current) fieldRefs.current.guestName = el; }}>
      ...
      <View style={[inputRow, errors.color && { borderColor: theme.colors.danger, marginBottom: 0 }]} ref={el => { if (fieldRefs && fieldRefs.current) fieldRefs.current.color = el; }}>
      ...
      <View style={[inputRow, errors.make && { borderColor: theme.colors.danger, marginBottom: 0 }]} ref={el => { if (fieldRefs && fieldRefs.current) fieldRefs.current.make = el; }}>
...
const GuestContactSection = memo(({ guestPhone, setGuestPhone, altGuestPhone, setAltGuestPhone, errors, setErrors, instantPark, eventAllowsInstantPark, fieldRefs }) => {
  return (
    <>
      ...
      <View style={[inputRow, errors.guestPhone && { borderColor: theme.colors.danger, marginBottom: 0 }]} ref={el => { if (fieldRefs && fieldRefs.current) fieldRefs.current.guestPhone = el; }}>
      ...
      <View style={[inputRow, errors.altGuestPhone && { borderColor: theme.colors.danger, marginBottom: 0 }]} ref={el => { if (fieldRefs && fieldRefs.current) fieldRefs.current.altGuestPhone = el; }}>
        <Ionicons name="phone-portrait-outline" size={20} color={theme.colors.primary} />
        <TextInput
          value={altGuestPhone}
...
const PhotoGridSection = memo(({ photos, errors, takePhoto, onRemovePhoto, fieldRefs }) => {
  return (
    <View ref={el => { if (fieldRefs && fieldRefs.current) fieldRefs.current.photos = el; }}>
    ...
    try {
      ...
      if (!gotServerResponse) {
        ...
        if (typeof msg === "string" && msg.includes("full")) {
          ...
          confirmDialog.info("Something went wrong", typeof msg === "string" ? msg : "Please check your connection and try again.");
        }
    ...
    <Screen testID="checkin-screen">
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
        ...
        >
          ...
          <Card style={{ marginBottom: rp(16) }}>
            <PhotoGridSection
              photos={photos} errors={errors} takePhoto={takePhoto} onRemovePhoto={onRemovePhoto} fieldRefs={fieldRefs}
            />
          </Card>
