...
export default function DriverQRDisplay() {
  ...
  return (
    <View className="flex-1 bg-[#F9FAFB]" testID="driver-qr-screen">
      ...
      <View className="flex-1 items-center justify-center px-6">
        <View className="bg-white rounded-3xl p-8 items-center shadow-lg" style={{ width: "100%" }}>
          <Text className="text-3xl font-black text-[#059669]">{plate}</Text>
        ...
        <TouchableOpacity
          ...
          className="border border-[#059669] rounded-2xl px-8 py-3 mt-6 flex-row items-center"
        >
          <Ionicons name="share-outline" size={20} color="#059669" />
          <Text className="text-[#059669] font-black tracking-widest ml-2">SHARE</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => router.replace("/(driver)/tasks")} className="bg-[#059669] rounded-2xl px-10 py-3 mt-4">
          <Text className="text-white font-black tracking-widest">DONE</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
