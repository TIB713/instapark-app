  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.primary }} testID="qr-screen">
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: rp(24) }}>
        ...
        >
          <Text style={{ fontFamily: theme.fontFamily.bold, fontSize: rs(11), fontWeight: "800", color: theme.colors.textSecondary, letterSpacing: rs(3) }}>
            GUEST QR CODE
          </Text>
          <Text style={{ fontFamily: theme.fontFamily.bold, fontSize: rs(28), fontWeight: "900", color: theme.colors.textPrimary, marginTop: rp(6) }}>{plate}</Text>
          <Text style={{ fontFamily: theme.fontFamily.regular, color: theme.colors.textSecondary, marginTop: rp(4), marginBottom: rp(24), fontSize: rs(13) }}>
          ...
          <Text style={{ fontFamily: theme.fontFamily.regular, color: theme.colors.textSecondary, fontSize: rs(11), marginTop: rp(18), textAlign: "center" }}>
        ...
        >
          <View style={{ paddingBottom: rp(10) }}>
            <View style={{ flexDirection: "row", alignItems: "center", marginBottom: rp(20) }}>
              ...
              <Text style={{ fontFamily: theme.fontFamily.bold, fontSize: rs(17), fontWeight: "900", color: theme.colors.textPrimary, marginLeft: rp(10), flex: 1 }}>
                Send Retrieval Link
              </Text>
            </View>

            <Text style={{ fontFamily: theme.fontFamily.bold, fontSize: rs(11), fontWeight: "800", color: theme.colors.textSecondary, letterSpacing: rs(3), marginBottom: rp(8) }}>
              GUEST MOBILE NUMBER
            </Text>
            <View
              style={{
            ...
            {phoneError && <Text style={{ fontFamily: theme.fontFamily.regular, color: theme.colors.danger, fontSize: rs(12), marginTop: rp(-12), marginBottom: rp(12) }}>* {phoneError}</Text>}

            <Text style={{ fontFamily: theme.fontFamily.regular, fontSize: rs(12), color: theme.colors.textMuted, marginBottom: rp(20), lineHeight: 18 }}>
