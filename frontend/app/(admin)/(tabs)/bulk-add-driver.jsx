  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.surfaceAlt }} testID="bulk-add-driver-screen">
      <Hero
        ...
        eyebrow="TEAM"
        onBack={() => router.replace("/(admin)/(tabs)/manage-employees?tab=drivers")}
      />
          ...
          {[
            ...
            <Card key={index} style={{ flexDirection: "row", alignItems: "center", padding: rp(theme.spacing.md) }}>
              <View style={{
                ...
                <Text style={{ fontFamily: theme.fontFamily.regular, color: theme.colors.primary, fontWeight: "bold", fontSize: rs(12) }}>{index + 1}</Text>
              </View>
              <Text style={{ fontFamily: theme.fontFamily.semibold, flex: 1, fontSize: rs(14), fontWeight: "600", color: theme.colors.textPrimary }}>
                {step}
              </Text>
            </Card>
          ))}
          ...
          <Card style={{ marginTop: rp(theme.spacing.lg), padding: rp(theme.spacing.lg) }}>
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
              <View style={{ flexDirection: "row", alignItems: "center", flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={{ fontFamily: theme.fontFamily.regular, fontSize: rs(14), fontWeight: "bold", color: theme.colors.textPrimary }} numberOfLines={1}>
                    {selectedFile.name}
                  </Text>
                  <Text style={{ fontFamily: theme.fontFamily.regular, fontSize: rs(12), color: theme.colors.textSecondary }}>
                    Ready to import
                  </Text>
                </View>
              </View>
      ...
      <Modal open={!!bulkResult} onClose={() => setBulkResult(null)}>
        <View style={{ alignItems: "center", padding: rp(theme.spacing.lg) }}>
          ...
          <Text style={{ fontFamily: theme.fontFamily.regular, fontSize: rs(14), color: theme.colors.textSecondary, textAlign: "center", marginBottom: rp(theme.spacing.xl) }}>
