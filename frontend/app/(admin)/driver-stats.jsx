        ...
        >
          ...
          <View style={[{ backgroundColor: "#fff", borderRadius: rp(24), padding: rp(18) }, cardShadow]}>
            ...
            <View ref={el => { if (fieldRefs.current) fieldRefs.current.email = el; }}  style={[miniInput, errors.email && { borderColor: "#EF4444" }]}>
              ...
              <TextInput value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" maxLength={100} placeholder="email@example.com" placeholderTextColor="#9CA3AF" style={miniInputText} />
            </View>
            ...
            <View ref={el => { if (fieldRefs.current) fieldRefs.current.licenseNumber = el; }}  style={[miniInput, errors.licenseNumber && { borderColor: "#EF4444" }]}>
              ...
              <TextInput value={licenseNumber} onChangeText={setLicenseNumber} autoCapitalize="characters" maxLength={16} placeholder="DL number" placeholderTextColor="#9CA3AF" style={miniInputText} />
            </View>
